...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team for practice, matches, and fitness training",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, learn stagecraft, and perform theater pieces",
    ...
    "Science Club": {
        "description": "Conduct experiments, explore STEM projects, and present discoveries",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
